...
export function ClassicTemplate({ resumeData }: ResumePreviewProps) {
  ...
  const headerClass = "mb-6 border-b-2 pb-4";
  const sectionTitleClass = "text-sm font-extrabold text-gray-700 mb-2 uppercase tracking-widest font-serif transition-colors duration-500";
