...
export function CreativeTemplate({ resumeData }: ResumePreviewProps) {
  ...
  const headerClass = "text-center mb-8 p-6 rounded-lg text-white transition-all duration-500";
  const sectionTitleClass = "text-xl font-bold text-[var(--accent-color)] mb-3 font-headline transition-colors duration-500";
