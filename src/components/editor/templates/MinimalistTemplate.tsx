...
export function MinimalistTemplate({ resumeData }: ResumePreviewProps) {
  ...
  const sectionTitleClass = "text-xs font-semibold text-gray-500 mb-2 uppercase tracking-widest transition-colors duration-500";
