...
export function ModernTemplate({ resumeData }: ResumePreviewProps) {
  ...
  const sectionTitleClass = "text-lg font-bold text-[var(--accent-color)] mb-2 uppercase tracking-wider font-headline transition-colors duration-500";
