  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        neuro: "bg-background shadow-neuro hover:shadow-neuro-inset active:shadow-neuro-inset transition-all active:scale-95",
        premium: "bg-primary text-primary-foreground shadow-[0_0_20px_rgba(45,106,159,0.35)] hover:shadow-[0_0_26px_rgba(45,106,159,0.45)] hover:-translate-y-0.5 transition-all duration-300",
        glass: "bg-glass text-foreground hover:bg-white/20 dark:hover:bg-white/10 transition-all border-white/20"
      },
      size: {
